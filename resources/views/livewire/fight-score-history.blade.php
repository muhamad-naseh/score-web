<table class="fi-ta-table w-full table-auto border border-gray-200 dark:border-white/5 divide-y divide-gray-200 text-start dark:divide-white/5">
    ...
    <tbody class="divide-y divide-gray-200 whitespace-nowrap dark:divide-white/5" wire:poll>
    @foreach($this->scores as $score)
        <tr wire:key="{{$score['id']}}" class="fi-ta-cell p-0 first-of-type:ps-1 last-of-type:pe-1 sm:first-of-type:ps-3 sm:last-of-type:pe-3 fi-table-cell-category.name">
            ...
            <td class="px-3 py-3.5 sm:first-of-type:ps-6 sm:last-of-type:pe-6 "><p class="text-center text-md leading-6 text-gray-950 dark:text-white tabular-nums">{{$score['type']}}</p></td>
